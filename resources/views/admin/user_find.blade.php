      ...
      名前
        <select id="user_id" name="user_id" id="tao">
          ...
          @foreach($users as $user)
            <option  name="name" value="{{ $user->name }}"
                @if(old("name") && old("name") == $user->name)
                  selected
                @endif
              >{{ $user->name }}</option>
          @endforeach
        </select><br>
      日付<input type="date" id="tao" name="start" value="{{ Request::query('attendance_date') }}"><br>
      日付<input type="date" id="tao" name="end" value="{{ Request::query('attendance_date') }}"><br>
